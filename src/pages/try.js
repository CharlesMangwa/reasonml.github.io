    ...
    return (
      <div css={[styles.toolbarButton, styles.shareButton]}>
        <input
          ...
          readOnly
        />
        <button onClick={this.onClick}>Partager</button>
        <span className={showConfirmation ? 'tooltip s-show-confirmation' : 'tooltip'} css={styles.tooltip}>
          <span className="arrow"></span>
          <span className="help">Cliquez pour copier dans votre presse-papiers</span>
          <span className="confirmation">Copié</span>
        </span>
      </div>
    );
  }
